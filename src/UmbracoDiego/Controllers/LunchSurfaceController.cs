...
using UmbracoDiego.Models;
using Umbraco.Web.Mvc;
using Umbraco.Core.Services;
using Umbraco.Core.Models;

namespace UmbracoDiego.Controllers
{
    public class LunchSurfaceController : SurfaceController
    {
        ...
        public ActionResult submit(Lunch lunch)
        {
            ...
            IDataTypeDefinition datatype = Services.DataTypeService.GetDataTypeDefinitionByName("LunchChoices");
